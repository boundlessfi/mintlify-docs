...
<Warning title="Important">
  If the bounty requires a Spark to apply, you'll spend one when you submit. Check that you have at least one before applying. [How to get Sparks](/concepts/power-cells).
</Warning>
...
- [How to earn Sparks](/concepts/power-cells)
...
- "I don't have enough Sparks" -> [Spark](/concepts/power-cells)
